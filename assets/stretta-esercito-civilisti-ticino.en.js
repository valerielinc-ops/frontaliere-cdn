const e={"blog.article.stretta-esercito-civilisti-ticino.body1":"## In Brief","blog.article.stretta-esercito-civilisti-ticino.body2":`## Impact on cross-border workers and Ticino society
...
To reduce FX leakage, compare [CHF-EUR exchange options](nav:exchange) and [banks for cross-border workers](nav:banks).`,"blog.article.stretta-esercito-civilisti-ticino.body3":`[object Object]

Compare the [CHF/EUR exchange rate](nav:exchange) in real time across providers: save up to 1.5% on monthly transfer fees.

*Source: [laregione.ch](https://www.laregione.ch/svizzera/votazioni-federali/1927552/stretta-utile-o-controproducente-per-il-paese-pareri-a-confronto)*`,"blog.article.stretta-esercito-civilisti-ticino.faq":`[{"q":"What is Diego Baratti's position on the army reform?","a":"Diego Baratti argues that national security requires more soldiers in the army. According to Baratti, the current situation is not sufficient to ensure the defense of the country, especially in an unstable international context."},{"q":"What does Zeno Casella say about the reduction of civil servants?","a":"Zeno Casella warns that the reduction of civil servants could have negative consequences on essential public services, such as healthcare and social assistance. Casella considers civil servants to be a fundamental resource for the community."},{"q":"How could the reform affect cross-border workers in Ticino?","a":"The reform could affect local public services, such as healthcare and social assistance, which are crucial for cross-border workers. Additionally, a stronger army could provide greater national security, which is important for the stability of cross-border workers' jobs."}]`};export{e as default};
