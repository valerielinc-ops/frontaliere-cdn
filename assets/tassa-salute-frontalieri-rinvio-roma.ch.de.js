const e={"blog.article.tassa-salute-frontalieri-rinvio-roma.body1":`## Kurz gefasst
...
Zu den brisanten Themen auf dem Tisch gehören die Anwendungsfragen des 2020 unterzeichneten Grenzgängerabkommens sowie weitere damit verbundene Dossiers, die den Grenzstreifen betreffen.`,"blog.article.tassa-salute-frontalieri-rinvio-roma.body2":`### Auswirkungen auf Grenzgänger
...
Anders als in der Vergangenheit, als Rückvergütungen automatisch anhand präziser Vereinbarungen erfolgten, erfordert die aktuelle Lage eine sorgfältige Abwägung der steuerlichen und rechtlichen Implikationen. Die Gesundheitssteuer würde – sofern bestätigt – eine bedeutende Neuerung in der steuerlichen Behandlung von Grenzgängern in der Schweiz darstellen.

## Empfohlene Tools
Für eine aktuelle Schätzung nutzen Sie den [Nettolohnrechner](nav:calculator) und den [CHF-EUR-Wechselvergleich](nav:exchange).`,"blog.article.tassa-salute-frontalieri-rinvio-roma.body3":`### Was in den kommenden Tagen zu erwarten ist
...
1. **Überprüfung der persönlichen Situation**: Prüfen, ob die Gesundheitssteuer bereits erhoben oder nur angekündigt wurde
2. Dokumentensammlung: Lohnabrechnungen, Verträge und sämtliche Kommunikationen bezüglich der Erstattungen aufbewahren
3. Expertenberatung: Prüfen, ob die Konsultation eines auf grenzüberschreitendes Recht spezialisierten Treuhänders notwendig ist
4. Nachrichtenmonitoring: Die offiziellen Aktualisierungen sowohl seitens der tessiner als auch der eidgenössischen Behörden genau verfolgen
...
Um die potenziellen Auswirkungen auf Ihre persönliche Steuersituation zu berechnen, nutzen Sie unseren [Lohnrechner](nav:calculator), um verschiedene Szenarien zu simulieren und zu bewerten, wie eventuelle Änderungen bei den Steuern oder Erstattungen Ihr persönliches Budget beeinflussen könnten.

*Quelle: [comozero.it](https://comozero.it/attualita/tassa-salute-frontalieri-accordo-italia-svizzera-ristorni-ticino/)*`,"blog.article.tassa-salute-frontalieri-rinvio-roma.faq":'[{"q":"Was ist genau die Gesundheitssteuer für Grenzgänger?","a":"Die Gesundheitssteuer ist eine Steuer, die die italienischen Behörden auf die Grenzgänger anwenden möchten, also auf diejenigen, die in der Schweiz arbeiten, aber in Italien wohnen. Laut einer von der Republik und Kanton Tessin in Auftrag gegebenen juristischen Expertise würde sich diese Steuer als eine echte Steuer und nicht als Beitrag darstellen und somit die bilateralen Steuerabkommen zwischen der Schweiz und Italien verletzen."},{"q":"Was sind die Ristorni der Grenzgänger und wie funktionieren sie?","a":"Die Ristorni der Grenzgänger sind steuerliche Ausgleichsmechanismen, die der Kanton Tessin als Reaktion auf die Gesundheitssteuer anwenden möchte. Es handelt sich um eine Gegenmaßnahme, die die Aussetzung oder Kürzung der an die Grenzgänger ausgezahlten Ristorni vorsehen könnte, als eine Form des diplomatischen Drucks auf Italien."},{"q":"Welche Frist hat der Kanton Tessin für eine Entscheidung?","a":"Der Staatsrat des Kantons Tessin muss bis zum 30. Juni 2026 eine Entscheidung treffen. Die kantonale Regierung wird sich in den nächsten Tagen treffen, wobei eine Entscheidung theoretisch für die ordentliche Sitzung am Mittwoch, dem 24. Juni, erwartet wird. Diese Frist ist politischer Natur und hängt mit der Notwendigkeit zusammen, auf die Situation der Gesundheitssteuer zu reagieren."},{"q":"Was wird beim Gipfeltreffen zwischen der Schweiz und Italien in Rom passieren?","a":"Bis Ende des laufenden Monats wird in Rom ein strategischer Gipfel zwischen der Bundesrätin Karin Keller-Sutter und dem italienischen Minister Giancarlo Giorgetti stattfinden. Das Treffen soll eine Bilanz der geleisteten Arbeit ziehen und die nächsten Schritte im bilateralen Steuerdossier festlegen, einschließlich der Frage der Gesundheitssteuer für die Grenzgänger."}]'};export{e as default};
