import{q as te,e as ne,a as J,g as h,d as Be,i as Xe,p as qn,u as Gn,_ as I,b as Kt,c as $t,f as zn,h as Kn,j as v,k as $n,l as Bn,S as he,m as jn,F as Qe,E as Ze,L as Yn,n as Bt,o as Jn,r as Xn,s as Qn,t as Zn,v as Tt,C as wt,w as yt,x as ei}from"./vendor-firebase-core.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function so(n,e){const t=h(n);await Le(!0,t,e);const{providerUserInfo:i}=await fi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=Tn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function ot(n,e,t=!1){const i=await O(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function Le(n,e,t){await ce(e);const i=Tn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";u(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(n,e,t){const i=_(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){u(a.handleCodeInApp,i,"argument-error"),a&&De(i,o,a)}s(r,t),await H(i,r,"getOobCode",Xi,"EMAIL_PASSWORD_PROVIDER")}function mo(n,e){const t=ge.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function go(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=h(n),r=G.credentialWithLink(e,t||ae());return u(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),at(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Io(n,e){const t=nt()?ae():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await pr(h(n),i);return r||[]}async function _o(n,e){const t=h(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&De(t.auth,r,e);const{email:s}=await Yi(t.auth,r);s!==n.email&&await n.reload()}async function Eo(n,e,t){const i=h(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&De(i.auth,s,t);const{email:o}=await Qi(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(n,e,t){return ss(n,e,t)}async function ss(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=_(n);X(n,e,D),await i._initializationPromise;const r=z(i,t);return await gt(r,i),r._openRedirect(i,e,"signInViaRedirect")}function Ko(n,e,t){return os(n,e,t)}async function os(n,e,t){const i=h(n);if(X(i.auth,e,D),I(i.auth.app))return Promise.reject(T(i.auth));await i.auth._initializationPromise;const r=z(i.auth,t);await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function $o(n,e,t){return as(n,e,t)}async function as(n,e,t){const i=h(n);X(i.auth,e,D),await i.auth._initializationPromise;const r=z(i.auth,t);await Le(!1,i,e.providerId),await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function Bo(n,e){return await _(n)._initializationPromise,Un(n,e,!1)}async function Un(n,e,t=!1){if(I(n.app))return Promise.reject(T(n));const i=_(n),r=z(i,e),o=await new ns(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Vn(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
