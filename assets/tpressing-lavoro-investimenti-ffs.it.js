const i={"blog.article.tpressing-lavoro-investimenti-ffs.body1":`## In breve
...
Parallelamente, il Cantone Ticino guarda con interesse al programma Ferrovia 2045, puntando a un pacchetto di investimenti stimato attorno ai 500 milioni di franchi. Le richieste ticinesi includono interventi strategici quali il raddoppio al Ponte Ticino e migliorie alla stazione di Bellinzona, superando l’obiettivo parziale del solo quarto marciapiede alla stazione di Locarno. Tuttavia, queste opere difficilmente saranno inserite nella prima versione del documento messo in consultazione nelle prossime settimane.

Con le FFS si è già discusso di queste richieste, e l’azienda sta valutando le proposte avanzate. La partita decisiva si giocherà nel corso del prossimo anno presso le Camere federali.

### Un incontro interlocutorio e la prospettiva di ulteriori confronti

Il dossier su FFS Cargo non si esaurisce con l’incontro di Berna: è prevista una nuova discussione a Bellinzona con una delegazione del Governo ticinese per approfondire i temi occupazionali e infrastrutturali. Intanto, una risoluzione contro lo smantellamento di FFS Cargo nel Ticino è all’attenzione delle Camere federali, a testimonianza della sensibilità del Cantone verso la tutela del lavoro e della mobilità economica locale.`,"blog.article.tpressing-lavoro-investimenti-ffs.body2":`L’incontro tra la deputazione ticinese e le FFS ha dato segnali chiari sull’impatto pratico per il mercato del lavoro e la mobilità nel Canton Ticino. Per i frontalieri, che spesso sono impiegati nelle ferrovie e nei servizi correlati, la conferma dell’assenza di licenziamenti è un elemento di serenità, anche se il trasferimento di posti di lavoro da Mendrisiotto a Bellinzona potrebbe modificare gli scenari quotidiani di pendolarismo.
...
Tuttavia, è importante considerare che queste opere sono ancora in fase di valutazione e non entreranno subito nella pianificazione ufficiale, lasciando aperta la partita politica e amministrativa che si giocherà nelle Camere federali nel prossimo anno.

Per i lavoratori frontalieri, seguire l’evoluzione di questo dossier è fondamentale per comprendere le opportunità e le sfide future del mercato del lavoro regionale e gli effetti sui permessi di lavoro e sulle assicurazioni sociali come AVS e LPP.

## Tool utili per il tuo caso
Per verificare in modo pratico il tuo scenario entro/oltre 20 km, usa il [calcolatore stipendio netto](nav:calculator) e la [guida dichiarazione redditi](nav:tax-return).`,"blog.article.tpressing-lavoro-investimenti-ffs.body3":`Per i frontalieri e i lavoratori del settore ferroviario ticinese, seguire da vicino gli sviluppi del dossier FFS Cargo e del programma Ferrovia 2045 è essenziale per pianificare la propria carriera e la gestione pratica dei propri permessi e assicurazioni.
...
4. Approfondire la fiscalità cross-border: L’imposta alla fonte e i ristorni sono aspetti sempre attuali per chi lavora in Ticino ma risiede in Italia; utilizzare strumenti come il nostro [calcolatore fiscale](nav:calculator) può aiutare a pianificare al meglio.
...
### Seguire le prossime fasi decisionali

Il confronto a Bellinzona con la delegazione del Governo ticinese e le decisioni che si prenderanno nelle Camere federali nel prossimo anno saranno momenti chiave per il futuro del lavoro nel settore ferroviario e per i frontalieri coinvolti. Prepararsi con informazioni precise e aggiornate è la strategia migliore per affrontare eventuali cambiamenti.

*Fonte: [rsi.ch](https://www.rsi.ch/s/3798032)*`,"blog.article.tpressing-lavoro-investimenti-ffs.faq":'[{"q":"Ci saranno licenziamenti per i frontalieri in Ticino dopo il ridimensionamento di FFS Cargo?","a":"No, le FFS hanno garantito che in Ticino non ci saranno licenziamenti nonostante il ridimensionamento di FFS Cargo, con una parte del personale trasferito da Mendrisiotto a Bellinzona."},{"q":"Quali investimenti sono previsti nel programma Ferrovia 2045 per il Ticino?","a":"Il Ticino punta a investimenti stimati attorno ai 500 milioni di franchi, includendo il raddoppio al Ponte Ticino e migliorie alla stazione di Bellinzona, tra gli interventi necessari."},{"q":"Come possono i frontalieri prepararsi ai cambiamenti derivanti dal ridimensionamento di FFS Cargo?","a":"I frontalieri dovrebbero monitorare aggiornamenti istituzionali, verificare permessi G, rivedere assicurazioni LAMal e AVS, approfondire fiscalità cross-border e considerare le opportunità di lavoro nel settore ferroviario."}]'};export{i as default};
